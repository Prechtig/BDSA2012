...
\begin{enumerate}
	\item Contract OC1: makeNewTask
	\begin{description}
		\item[Operation:] makeNewTask(type, description, date, time, repetition)
		\item[Cross References:] Use Cases: UC1
		\item[Preconditions:] The user is logged in.
		\item[Postconditions:] The new task is saved in the system.
	\end{description}
\end{enumerate}
